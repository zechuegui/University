...
public class GoogleCredential {
    ...
    private static GoogleCredential instance = null;

    private static final String APPLICATION_NAME = "Template";
    private static final String CREDENTIAL_FILEPATH = "./credentials.json";
    ...
    private GoogleCredential(List<String> scopes) {
    ...
    public static GoogleCredential getInstance(List<String> scopes) {
        if (instance == null) {
            instance = new GoogleCredential(scopes);
        }
        return instance;
    }
